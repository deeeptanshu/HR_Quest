...
function toggleMute() {
  ...
  localStorage.setItem('hrquest-muted', isMuted.value.toString());
...
function handleCloseTutorial() {
  ...
  localStorage.setItem('hrquest-tutorial-seen', 'true');
}
...
onMounted(() => {
  ...
  const savedMuteState = localStorage.getItem('hrquest-muted');
  ...
  EventBus.on('player-name-set', (name) => {
    ...
    const hasSeenTutorial = localStorage.getItem('hrquest-tutorial-seen');
    if (!hasSeenTutorial) {
...
<template>
  <div id="app" :class="{ 'mobile-view': isMobile, 'battle-active': showBattle }">
    <div v-if="isMobile && isPortrait" class="orientation-lock">
      <div class="orientation-card">
        ...
        <div class="orientation-subtitle">
          HR Quest is designed for desktop play. For the best experience, continue on a computer.
        </div>
        <a
          class="orientation-link"
          href="https://www.shrm.org/topics-tools/news/podcasts"
          target="_blank"
          rel="noopener noreferrer"
        >
          Explore SHRM Podcasts →
        </a>
      </div>
    </div>
        ...
        <div class="footer-column credits-column mobile-credits">
          ...
          <div class="credits-content">
            <div class="credits-line credits-inspiration">
              ...
              <a href="https://www.shrm.org/topics-tools/news/podcasts" target="_blank" rel="noopener noreferrer" class="credits-avatar-link" data-tooltip="HR Quest is a fan-made RPG inspired by SHRM HR podcasts. Built to make HR knowledge fun and accessible.">
                <img class="credits-avatar" src="/assets/favicon.png" alt="HR Quest" />
              </a>
              <a href="https://www.shrm.org/topics-tools/news/podcasts" target="_blank" rel="noopener noreferrer" class="credits-lenny" data-tooltip="HR Quest is a fan-made RPG inspired by SHRM HR podcasts. Built to make HR knowledge fun and accessible.">SHRM Podcast episodes</a>
            </div>
            <div class="credits-line credits-row">
              <span>Made for HR professionals</span>
              <span class="credits-separator">•</span>
              <a href="https://github.com/deeeptanshu/HR_Quest" target="_blank" rel="noopener noreferrer" class="credits-github" title="Contribute on GitHub">
            ...
            <div class="credits-line credits-disclaimer">
              HR knowledge game. Questions from SHRM podcast content. Avatars are AI-generated.
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="game-header">
      <h1 class="game-title">HR Quest</h1>
